...
import {
  ...
  RuleSet,
  EmptyWarningContext,
} from './query-builder-quo.interfaces';
...
import { QueryFieldDirective, QueryInputDirective, QueryOperatorDirective, QueryEntityDirective, QuerySwitchGroupDirective, QueryButtonGroupDirective, QueryRemoveButtonDirective, QueryEmptyWarningDirective } from './query-builder-quo.directive';

export const CONTROL_VALUE_ACCESSOR: any = {
  provide: NG_VALUE_ACCESSOR,
  useExisting: forwardRef(() => QueryBuilderQuoComponent),
  multi: true
};
...
@Component({
  selector: 'query-builder-quo',
  templateUrl: './query-builder-quo.component.html',
  styleUrls : ['./query-builder-quo.component.scss'],
  providers: [CONTROL_VALUE_ACCESSOR, VALIDATOR]
})
export class QueryBuilderQuoComponent implements OnInit, OnChanges, ControlValueAccessor, Validator {
  public fields: Field[];
